...
class Controller:
    ...
    def run(self):
        self.pos_control_values = self.start_pose.copy()
        while not rospy.is_shutdown():
            ...
            if "Messages" in response:
                ...
                if len(messages) > 0:
                    ...
                    # pos
                    pose.target.position.x = pos_control_values[0] / 200
                    pose.target.position.y = pos_control_values[1] / 200
                    pose.target.position.z = pos_control_values[2] / 200

                    # orientation
                    yaw = pos_control_values[3] / 100
                    pitch = pos_control_values[4] / 100
                    roll = pos_control_values[5] / 100
